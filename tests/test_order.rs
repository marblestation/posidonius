...
fn ias15_binary_setup1() -> posidonius::Ias15 {
    ...
    //let star_evolution_type = posidonius::EvolutionType::Baraffe1998(primary_star_mass); // M-Dwarf (mass = 0.10) or SolarLike ConstantDissipation (mass = 1.0)
    //let star_evolution_type = posidonius::EvolutionType::Baraffe2015(primary_star_mass); // mass = 0.01 .. 1.40
    //let star_evolution_type = posidonius::EvolutionType::Leconte2011(primary_star_mass); // BrownDwarf (mass = 0.01 .. 0.08)
    let primary_star_evolution_type = posidonius::EvolutionType::BolmontMathis2016(primary_star_mass); // SolarLike Evolving dissipation (mass = 0.40 .. 1.40)
    //let star_evolution_type = posidonius::EvolutionType::GalletBolmont2017(primary_star_mass); // SolarLike Evolving dissipation (mass = 0.30 .. 1.40)
    //let star_evolution_type = posidonius::EvolutionType::LeconteChabrier2013; // Jupiter
    //let star_evolution_type = posidonius::EvolutionType::NonEvolving;
    let primary_star = common::stars::solar_like_primary(primary_star_mass, primary_star_evolution_type);
    let secondary_star_mass: f64 = 1.2; // Solar masses
    //let star_evolution_type = posidonius::EvolutionType::Baraffe1998(secondary_star_mass); // M-Dwarf (mass = 0.10) or SolarLike ConstantDissipation (mass = 1.0)
    //let star_evolution_type = posidonius::EvolutionType::Baraffe2015(secondary_star_mass); // mass = 0.01 .. 1.40
    //let star_evolution_type = posidonius::EvolutionType::Leconte2011(secondary_star_mass); // BrownDwarf (mass = 0.01 .. 0.08)
    let secondary_star_evolution_type = posidonius::EvolutionType::BolmontMathis2016(secondary_star_mass); // SolarLike Evolving dissipation (mass = 0.40 .. 1.40)
    //let star_evolution_type = posidonius::EvolutionType::GalletBolmont2017(secondary_star_mass); // SolarLike Evolving dissipation (mass = 0.30 .. 1.40)
    //let star_evolution_type = posidonius::EvolutionType::LeconteChabrier2013; // Jupiter
    //let star_evolution_type = posidonius::EvolutionType::NonEvolving;
    let secondary_star = common::stars::solar_like_secondary(&primary_star, secondary_star_mass, secondary_star_evolution_type, general_relativity_implementation);
