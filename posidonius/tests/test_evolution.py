...
class Evolution(TestBase):
    ...
    def test_solar_like_baraffe1998(self):
    ...
    def test_solar_like_baraffe2015(self):
        current_function_name = inspect.stack()[0][3][5:] # Remove first 5 characters "test_"
        expected_json_filename, json_filename = common.setup(self.current_dirname, self.current_filename, current_function_name)
    ...
    def test_solar_like_bolmontmathis2016(self):
        current_function_name = inspect.stack()[0][3][5:] # Remove first 5 characters "test_"
        expected_json_filename, json_filename = common.setup(self.current_dirname, self.current_filename, current_function_name)
    ...
    def test_solar_like_galletbolmont2017(self):
        current_function_name = inspect.stack()[0][3][5:] # Remove first 5 characters "test_"
        expected_json_filename, json_filename = common.setup(self.current_dirname, self.current_filename, current_function_name)
    ...
    def test_solar_like_non_evolving(self):
        current_function_name = inspect.stack()[0][3][5:] # Remove first 5 characters "test_"
        expected_json_filename, json_filename = common.setup(self.current_dirname, self.current_filename, current_function_name)
    ...
    def test_brown_dwarf_leconte2011(self):
        current_function_name = inspect.stack()[0][3][5:] # Remove first 5 characters "test_"
        expected_json_filename, json_filename = common.setup(self.current_dirname, self.current_filename, current_function_name)
    ...
    def test_brown_dwarf_non_evolving(self):
        current_function_name = inspect.stack()[0][3][5:] # Remove first 5 characters "test_"
        expected_json_filename, json_filename = common.setup(self.current_dirname, self.current_filename, current_function_name)
    ...
    def test_m_dwarf_baraffe1998(self):
        current_function_name = inspect.stack()[0][3][5:] # Remove first 5 characters "test_"
        expected_json_filename, json_filename = common.setup(self.current_dirname, self.current_filename, current_function_name)
        ...
        #star_evolution_type = posidonius.LeconteChabrier2013(True) # Jupiter with dissipation of dynamical tides
        #star_evolution_type = posidonius.NonEvolving()
        universe.add_m_dwarf(star_mass, star_dissipation_factor_scale, star_position, star_velocity, star_rotation_period, general_relativity_implementation, star_evolution_type)
        common.basic_configuration(universe)
    ...
    def test_m_dwarf_baraffe2015(self):
        current_function_name = inspect.stack()[0][3][5:] # Remove first 5 characters "test_"
        expected_json_filename, json_filename = common.setup(self.current_dirname, self.current_filename, current_function_name)
