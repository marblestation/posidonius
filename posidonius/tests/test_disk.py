...
class Disk(TestBase):
    ...
    def test_enabled_disk(self):
        ...
        universe.add_solar_like_with_disk(star_mass, star_dissipation_factor_scale, star_position, star_velocity, star_rotation_period, star_evolution_type, wind_k_factor=4.0e-18, wind_rotation_saturation=1.7592918860102842)
