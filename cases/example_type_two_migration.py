...
if __name__ == "__main__":
    ...
    universe.add_particle(star_mass, star_radius, star_dissipation_factor, star_dissipation_factor_scale, star_radius_of_gyration_2, star_love_number, star_fluid_love_number, star_type_two_migration_time, star_type_two_migration_inner_disk_edge_distance, star_position, star_velocity, star_spin, star_evolution_type)
