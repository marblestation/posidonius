...
impl Particle {
    pub fn new(mass: f64, radius: f64, dissipation_factor: f64, dissipation_factor_scale: f64, radius_of_gyration_2: f64, love_number: f64, fluid_love_number: f64, position: Axes, velocity: Axes, spin: Axes, evolution_type: EvolutionType) -> Particle {
        ...
        Particle { id:id, mass:mass, mass_g: mass*K2, radius: radius, 
                    ...
                    radial_velocity: 0., norm_velocity_vector:0., norm_velocity_vector_2:0., norm_spin_vector_2: 0., distance:0.,
                    scalar_product_of_vector_position_with_stellar_spin:0., scalar_product_of_vector_position_with_planetary_spin:0.,
                    factor_for_the_force_induced_by_star_rotation:0., factor_for_the_force_induced_by_planet_rotation: 0.,
    ...
    pub fn new_solar_like(mass: f64, dissipation_factor_scale: f64, position: Axes, velocity: Axes, rotation_period: f64, evolution_type: EvolutionType) -> Particle {
        match evolution_type {
    ...
    pub fn new_m_dwarf(mass: f64, dissipation_factor_scale: f64, position: Axes, velocity: Axes, rotation_period: f64, evolution_type: EvolutionType) -> Particle {
        match evolution_type {
    ...
    pub fn new_jupiter_like(mass: f64, dissipation_factor_scale: f64, position: Axes, velocity: Axes, spin: Axes, evolution_type: EvolutionType) -> Particle {
        match evolution_type {
    ...
    pub fn new_earth_like(mass: f64, dissipation_factor_scale: f64, position: Axes, velocity: Axes, spin: Axes) -> Particle {
        let evolution_type = EvolutionType::NonEvolving;
        ...
        let radius_factor : f64 = (0.0592*0.7+0.0975) * (mass.log10() + M2EARTH.log10()).powi(2) 
                                 + (0.2337*0.7+0.4938) * (mass.log10() + M2EARTH.log10()) 
                                 + 0.3102*0.7+0.7932;
        let radius: f64 = radius_factor * R_EARTH;
    ...
    pub fn new_terrestrial(mass: f64, radius_factor: f64, dissipation_factor_scale: f64, position: Axes, velocity: Axes, spin: Axes) -> Particle {
        let mut terrestrial = Particle::new_earth_like(mass, dissipation_factor_scale, position, velocity, spin);
        // Change radius
    ...
    pub fn new_gas_giant(mass: f64, radius_factor: f64, dissipation_factor_scale: f64, position: Axes, velocity: Axes, spin: Axes) -> Particle {
        let evolution_type = EvolutionType::NonEvolving;
        let mut gas_giant = Particle::new_jupiter_like(mass, dissipation_factor_scale, position, velocity, spin, evolution_type);
        // Change radius
